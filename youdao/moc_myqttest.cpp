...
void myQtTest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData myQtTest::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject myQtTest::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_myQtTest,
      qt_meta_data_myQtTest, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &myQtTest::getStaticMetaObject() { return staticMetaObject; }
